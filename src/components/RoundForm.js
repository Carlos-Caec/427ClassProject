...
class RoundForm extends React.Component {
    ...
    handleChange = (event) => {
        ...
        if (name === "seconds") {
          ...
          let newSGS = this.computeSGS(this.state.Points, this.state.minutes, 
                                       newSec);
          this.setState({seconds: newSec, SGS: newSGS});
        } else if (name === "Points") {
          let newPoints = event.target.value;
          let newSGS = this.computeSGS(newPoints, this.state.minutes, 
            this.state.seconds);
          this.setState({Points: newPoints, SGS: newSGS});
        } else if (name === "minutes") {
            let newMin = event.target.value;
            let newSGS = this.computeSGS(this.state.Points, newMin, 
              this.state.seconds);
    ...
    computeSGS = (Points, min, sec) => {
      return (Number(Points) + Number(min)) 
                  + ":" + sec;
    }
